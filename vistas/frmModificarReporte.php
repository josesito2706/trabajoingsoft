...
<body>
  ...
  <div class="container">
    ...
    <form method="post" action="../controladores/reporteController.php">
      ...
      <select id="estadoR" name="estadoR" required>
        <option value="">-- Seleccione --</option>
        <option value="Pendiente"     <?= $estadoR=='Pendiente'   ? 'selected':'' ?>>Pendiente</option>
        <option value="En Progreso"   <?= $estadoR=='En Progreso' ? 'selected':'' ?>>En Progreso</option>
        <option value="Completado"    <?= $estadoR=='Completado'  ? 'selected':'' ?>>Completado</option>
        <option value="Cancelado"     <?= $estadoR=='Cancelado'   ? 'selected':'' ?>>Cancelado</option>
      </select>
